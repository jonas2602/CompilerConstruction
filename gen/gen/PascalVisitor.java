...
public interface PascalVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PascalParser#variableAccess}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVariableAccess(PascalParser.VariableAccessContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PascalParser#pointerVariable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPointerVariable(PascalParser.PointerVariableContext ctx);
	/**

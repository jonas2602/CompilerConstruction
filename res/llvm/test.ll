...
@.str = private unnamed_addr constant [9 x i8] c"abcde\5C\0A\5C\00", align 1
...
@.str.3 = private unnamed_addr constant [7 x i8] c"abc %f\00", align 1
@.str.4 = private unnamed_addr constant [3 x i8] c"%f\00", align 1
@.str.5 = private unnamed_addr constant [5 x i8] c"%c%f\00", align 1

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @main() #0 {
  %1 = alloca i8*, align 8
  store i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8** %1, align 8
  call void @arraytest()
  ret i32 0
}
...
define dso_local void @structtest() #0 {
  ...
  store i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), i8** %3, align 8
  ret void
}
...
define dso_local signext i8 @test(i8 signext, i8 signext) #0 {
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), double %7)
...
define dso_local float @addf(float) #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i32 0, i32 0), double %9)
...
define dso_local void @myprint(i32, float) #0 {
  ...
  %7 = fpext float %6 to double
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0), i32 %5, double %7)
  ret void
}
